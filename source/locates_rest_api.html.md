...
# Introduction
The Clear Street Locates service enables users to request Shot Stock Locates via a ReST API. This specification documents the service endpoints and the interaction pattern for this API.
